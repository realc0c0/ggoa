...
const DICE_CONFIG = {
    ...
    headers: {
        ...
        "authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjoiNjc0YmI1ZGE5NGE4ZjI3NmQxMGMyN2E4IiwiaWF0IjoxNzQyNTQ4ODI1LCJleHAiOjE3NDI2MzUyMjUsInR5cGUiOiJhY2Nlc3MifQ.btMUNNwddOXYQK0LUeJ1NMDM18DWfZ_zxkWXwNFr5Vk", // Replace with valid token
...
function createBot(token) {
    ...
    bot.onText(/\/start/, async (msg) => {
        ...
        await bot.sendMessage(chatId, 'Hello! I am your dice game bot. Use /run to start the dice game script. or send  /stop to stop the script . or send /setpayload to set a custom payload. or send /showpayload to see the current payload. or send /resetpayload to reset the payload to the default.');
    });
